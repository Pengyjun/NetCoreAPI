    ...
    public class CertificateService : ICertificateService
    {
        ...
        public async Task<PageResult<CertificateSearch>> SearchCertificateAsync(CertificateRequest requestBody)
        {
            ...
            var rr = await _dbContext.Queryable<User>()
                ...
                //.WhereIF(requestBody.Certificates == CertificatesEnum.FCertificate, (t1, t2, t3, t4, t5, t6) => )
                //.WhereIF(requestBody.Certificates == CertificatesEnum.SCertificate, (t1, t2, t3, t4, t5, t6) => !string.IsNullOrEmpty(t2.SCertificate))
                //.WhereIF(requestBody.Certificates == CertificatesEnum.PXHGZ, (t1, t2, t3, t4, t5, t6) => !string.IsNullOrEmpty(t2.TrainingCertificate))
                //.WhereIF(requestBody.Certificates == CertificatesEnum.JKZ, (t1, t2, t3, t4, t5, t6) => !string.IsNullOrEmpty(t2.HealthCertificate))
                //.WhereIF(requestBody.Certificates == CertificatesEnum.HYZ, (t1, t2, t3, t4, t5, t6) => !string.IsNullOrEmpty(t2.SeamanCertificate))
                //.WhereIF(requestBody.Certificates == CertificatesEnum.HZ, (t1, t2, t3, t4, t5, t6) => !string.IsNullOrEmpty(t2.PassportCertificate))
