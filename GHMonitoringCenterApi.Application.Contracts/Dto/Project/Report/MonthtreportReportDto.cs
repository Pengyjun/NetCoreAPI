...
namespace GHMonitoringCenterApi.Application.Contracts.Dto.Project.Report
{
    ...
    /// 项目月报导出
    /// </summary>
    public class MonthtreportListReportDto 
    {
        /// <summary>
        /// excel导出所需标题字段
        /// </summary>
        ...
        /// 项目月报数据列表
        /// </summary>
        public List<MonthtreportReportDto> MonthtreportData { get; set; }
    }

    /// <summary>
    /// 项目月报响应Dto
    /// </summary>
    public class MonthtreportReportDto
    {
        /// <summary>
        /// 项目id
        /// </summary>
        ...
        /// 进度偏差主因
        /// </summary>
        public string ProgressDeviationReason { get; set; }
        /// <summary>
        /// 进度偏差原因简述
        /// </summary>
        ...
        /// 成本偏差主因
        /// </summary>
        public string CostDeviationReason { get; set; }
