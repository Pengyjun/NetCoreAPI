...
namespace GHMonitoringCenterApi.Application.Contracts.Dto.Job
{
    ...
    /// </summary>
    public class SubmitJobOfMonthReportRequestDto : SubmitJobRequestDto<SaveProjectMonthReportRequestDto>
    {
        /// <summary>
        /// 业务类型
        /// </summary>
        ...
        /// 月份
        /// </summary>
        public override int DateMonth { get { return BizData.DateMonth; } }
