...
namespace GHMonitoringCenterApi.Application.Contracts.IService.ProductionValueImport
{
    ...
    public interface IProductionValueImportService
    {
        ...
        Task<ResponseAjaxResult<List<ProductionDayReportHistoryResponseDto>>> ExcelJJtSendMessageAsync(ImportHistoryProductionValuesRequestDto importHistoryProductionValuesRequestDto,int needMonth);
    }
}
