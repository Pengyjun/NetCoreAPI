...
namespace GHMonitoringCenterApi.SqlSugarCore
{
    ...
    /// Sqlsugar上下文
    /// </summary>
    public static class GHMonitoringCenterApiDbContext
    {
            ...
            }, db =>
            {
                ...
                db.Aop.DataExecuting = (value, entityInfo) =>
                {
                        ...
                        if (entityInfo.PropertyName == "CreateId")
                        {
                            ...
                            if (httpContent != null)
                            {
                                ...
                                if (existKey)
                                {
                                    ...
                                    {
                                        var userInfo = JsonConvert.DeserializeObject<CurrentUser>(userValue);
                                        if (userInfo != null)
                                        {
                    ...
                    if (entityInfo.OperationType == DataFilterType.UpdateByObject)
                    {
                        ...
                        var isDelete = ((GHMonitoringCenterApi.Domain.BaseEntity<System.Guid>)entityInfo.EntityValue).IsDelete;
