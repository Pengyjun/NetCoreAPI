...
namespace GDCMasterDataReceiveApi.Domain.Models
{
    ...
    public class LouDong : BaseEntity<long>
    {
        ...
        /// </summary>
        [SugarColumn(Length = 10, ColumnName = "BuildingName")]
        public string ZBLDG { get; set; }
        /// <summary>
        /// 业态信息 ：该楼栋的业态，可多值，需选择末级；通用类字典102接口下发 多值用英文逗号隔开
        /// </summary>
        [SugarColumn(Length = 200, ColumnName = "BusinessFormatInformation")]
        public string ZFORMATINF { get; set; }
        /// <summary>
        /// 项目主数据编码 ：该楼栋所属的分期（子项目）编码，如无分期（子项目）可填主项目的编码
        /// </summary>
        [SugarColumn(Length = 12, ColumnName = "ProjectMDEncoding")]
