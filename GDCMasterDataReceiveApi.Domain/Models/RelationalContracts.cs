...
namespace GDCMasterDataReceiveApi.Domain.Models
{
    ...
    public class RelationalContracts : BaseEntity<long>
    {
        ...
        /// </summary>
        [SugarColumn(Length = 4, ColumnName = "DetailedLineItemsOfTheEntrustedUnit")]
        ...
        /// </summary>
        [SugarColumn(Length = 9, ColumnName = "EntrustingUnitCode")]
        public string? ZDELEGATE_ORG { get; set; }
        /// <summary>
        /// 委托状态:2023年2月20日多机构新增值域；1-启用0-停用
        /// </summary>
        [SugarColumn(Length = 1, ColumnName = "EntrustmentStatus")]
        ...
        /// </summary>
        [SugarColumn(Length = 20, ColumnName = "InstitutionalCode")]
        ...
        /// </summary>
        [SugarColumn(Length = 18, ColumnName = "AccountingInstitutionCode")]
        public string? ZACO { get; set; }
        /// <summary>
        /// 组织树编码:2023年2月20日多机构新增值域：1-组织机构树，2-核算组织树，3-管理组织树
        /// </summary>
        [SugarColumn(Length = 10, ColumnName = "OrganizationalTreeCode")]
