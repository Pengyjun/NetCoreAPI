...
namespace GDCMasterDataReceiveApi.Domain.Models
{
    ...
    public class RoomNumber : BaseEntity<long>
    {
        ...
        /// 楼栋编码:该房号所属的楼栋编码
        /// </summary>
        [SugarColumn(Length = 5, ColumnName = "BuildingCode")]
        public string ZBLDG { get; set; }
        /// <summary>
        /// 业态信息:该房号的业态，单选，在楼栋业态范围内中选择；通用类字典102接口下发
        /// </summary>
        [SugarColumn(Length = 10, ColumnName = "BusinessFormatInformation")]
