...
namespace GDCMasterDataReceiveApi.Domain.Models
{
    ...
    public class AccountingOrganization : BaseEntity<long>
    {
        ...
        /// 机构主数据编码:机构主数据的唯一标识
        /// </summary>
        [SugarColumn(Length = 9, ColumnName = "")]
        public string MDM_CODE {  get; set; }
        /// <summary>
        /// 机构名称（中文）:机构的规范全称
        /// </summary>
        [SugarColumn(Length = 200, ColumnName = "")]
        ...
        /// 机构主数据编码（旧）
        /// </summary>
        [SugarColumn(Length = 20, ColumnName = "")]
        ...
        /// </summary>
        [SugarColumn(Length = 500, ColumnName = "")]
        ...
        /// 层级:当前节点所处树形的层级
        /// </summary>
        [SugarColumn(Length = 2, ColumnName = "")]
        ...
        /// 机构编码:机构27位有含义编码
        /// </summary>
        [SugarColumn(Length = 27, ColumnName = "")]
        public string ZORGNO {  get; set; }
        /// <summary>
        /// 机构属性:机构的管理属性 
        /// </summary>
        [SugarColumn(Length = 3, ColumnName = "")]
        ...
        /// </summary>
        [SugarColumn(Length = 100, ColumnName = "")]
        public string ZORGLOC {  get; set; }
        /// <summary>
        /// 地域属性:机构所处的位置对应的中交的区域划分
        /// </summary>
        [SugarColumn(Length = 5, ColumnName = "")]
        public string ZREGIONAL {  get; set; }
        /// <summary>
        /// 注册号/统一社会信用代码
        /// </summary>
        [SugarColumn(Length = 64, ColumnName = "")]
        ...
        /// </summary>
        [SugarColumn(Length = 10, ColumnName = "")]
        public string ZTREEID1 {  get; set; }
        /// <summary>
        /// 组织树版本号
        /// </summary>
        [SugarColumn(Length = 4, ColumnName = "")]
